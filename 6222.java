...
public class CustomerAction extends Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        // Kiểm tra xem có phải là submit form tìm kiếm không
        boolean isSearchSubmit = request.getParameter("page") == null && !"delete".equals(action);
        
        // Xử lý page từ form submit
        if (isSearchSubmit) {
            // Nếu là submit form tìm kiếm, reset về trang 1
            customerForm.setCurrentPage(1);
        } else if (request.getParameter("page") != null) {
            // Nếu là click nút phân trang, lấy số trang từ parameter
        ...
        // Lưu điều kiện tìm kiếm và trang hiện tại vào session
        ...
        session.setAttribute("currentPage", String.valueOf(customerForm.getCurrentPage()));
        ...
        // Cập nhật lại session sau khi điều chỉnh trang
...
<body>
    ...
    <!-- Form phân trang - tách riêng -->
    <html:form action="/search" method="post" styleId="paginationForm">
        <!-- Copy các hidden field từ form tìm kiếm để giữ điều kiện search -->
        ...
        <div style="text-align: center; margin-top: 20px;">
            ...
            <logic:equal name="customerForm" property="currentPage" value="1">
                <html:submit property="page" value="1" disabled="true">First</html:submit>
            </logic:equal>
            <logic:notEqual name="customerForm" property="currentPage" value="1">
                <html:submit property="page" value="1">First</html:submit>
            </logic:notEqual>
            ...
            <logic:equal name="customerForm" property="currentPage" value="1">
                <html:submit property="page" value='<%= String.valueOf(Integer.parseInt((String)pageContext.getAttribute("prevPage")) - 1) %>' disabled="true">Previous</html:submit>
            </logic:equal>
            <logic:notEqual name="customerForm" property="currentPage" value="1">
                <html:submit property="page" value='<%= String.valueOf(Integer.parseInt((String)pageContext.getAttribute("prevPage")) - 1) %>'>Previous</html:submit>
            </logic:notEqual>
            ...
            <logic:equal name="customerForm" property="currentPage" value='<%= (String)pageContext.getAttribute("maxPageValue") %>'>
                <html:submit property="page" value='<%= String.valueOf(Integer.parseInt((String)pageContext.getAttribute("nextPage")) + 1) %>' disabled="true">Next</html:submit>
            </logic:equal>
            <logic:notEqual name="customerForm" property="currentPage" value='<%= (String)pageContext.getAttribute("maxPageValue") %>'>
                <html:submit property="page" value='<%= String.valueOf(Integer.parseInt((String)pageContext.getAttribute("nextPage")) + 1) %>'>Next</html:submit>
            </logic:notEqual>

            <!-- Nút Last -->
            <bean:define id="lastPage">
                <bean:write name="maxPage"/>
            </bean:define>
            <logic:equal name="customerForm" property="currentPage" value='<%= (String)pageContext.getAttribute("maxPageValue") %>'>
                <html:submit property="page" value='<%= (String)pageContext.getAttribute("lastPage") %>' disabled="true">Last</html:submit>
            </logic:equal>
            <logic:notEqual name="customerForm" property="currentPage" value='<%= (String)pageContext.getAttribute("maxPageValue") %>'>
                <html:submit property="page" value='<%= (String)pageContext.getAttribute("lastPage") %>'>Last</html:submit>
            </logic:notEqual>
        </div>
    </html:form>
    ...
    <html:form action="/search" method="post" styleId="customerForm">
        ...
        <div style="text-align: right; margin: 20px 10% 0 0;">
            <html:button property="" onclick="window.location.href='add.do?action=add'">Add New</html:button>
